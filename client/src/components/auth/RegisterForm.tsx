            ...
            <div className="lg:w-3/5 p-5 lg:p-7">
              <div className="max-w-md mx-auto h-full flex flex-col">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 flex-1">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-semibold py-3 rounded-lg transition-all duration-300 shadow-lg mt-4 text-sm hover:from-indigo-600 hover:to-blue-600 hover:shadow-xl hover:scale-105"
                  >
                    Create Account
                  </button>
