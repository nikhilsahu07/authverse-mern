        ...
        <div className="flex flex-col lg:flex-row min-h-[550px]">
          ...
          <div className="lg:w-3/5 p-5 lg:p-7">
            <div className="max-w-md mx-auto h-full flex flex-col">
              ...
              <div className="mb-5 text-center">
                ...
                <p className="text-blue-100/70 text-base">Sign in to your secure account</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4 flex-1">
                ...
                <div className="flex items-center justify-between py-1">
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-slate-600/50 bg-slate-700/50 text-indigo-500 focus:ring-indigo-500 focus:ring-offset-0"
                    />
                    <span className="text-blue-100/70 text-sm">Remember me</span>
                  </label>
                  <Link
                    to="/forgot-password"
                    className="text-blue-100/70 hover:text-blue-100 transition-colors underline text-sm"
                  >
                    Forgot Password?
                  </Link>
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-indigo-500 to-blue-500 text-white font-semibold py-3 rounded-lg hover:from-indigo-600 hover:to-blue-600 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 text-sm"
                >
                  Sign In
                </button>
                ...
                <div className="text-center text-sm">
                  ...
                  <Link to="/signup" className="text-blue-300 font-semibold hover:text-blue-200 transition-colors">
                    Create Account
                  </Link>
                </div>
              </form>
          ...
          <div className="lg:w-2/5 bg-slate-900/40 backdrop-blur-sm p-5 lg:p-7 flex flex-col justify-center border-l border-slate-700/50">
            <div className="text-white">
              <h2 className="text-xl lg:text-2xl font-bold mb-5">Secure by Design</h2>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 text-base">End-to-End Encryption</h3>
                    <p className="text-blue-100/60 text-sm">Your data is protected with military-grade encryption</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 text-base">Multi-Factor Authentication</h3>
                    <p className="text-blue-100/60 text-sm">Additional security layers to protect your account</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 className="font-semibold mb-1 text-base">Zero-Trust Security</h3>
                    <p className="text-blue-100/60 text-sm">Every request is verified and authenticated</p>
                  </div>
                </div>
              </div>

              <div className="mt-5 p-4 bg-slate-800/60 backdrop-blur rounded-lg border border-slate-700/50">
                <h3 className="font-semibold text-base mb-2">Trusted by 10,000+ companies</h3>
